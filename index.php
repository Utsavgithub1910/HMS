...
function alphaOnly(event) {
        ...
        function validatePassword() {
            ...
            var regex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@#$%^&+=!()\-\[\]])[A-Za-z\d@#$%^&+=!()\-\[\]]{8,29}$/;

            if (!regex.test(pass)) {
                errorMessage.style.color = '#f55252';
                errorMessage.innerHTML = "Password must contain at least one uppercase letter, one lowercase letter, one number, and one special symbol from @#$%^&+=!()-[]. It should be between 8 and 29 characters long.";
                return false;
            } else {
                errorMessage.style.color = '#5dd05d';
                errorMessage.innerHTML = "Valid Password";
                return true;
            }
        }
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://www.pngfind.com/pngs/m/65-651964_hospital-png-transparent-png.png" alt=""/>
                        <h3>Welcome</h3>
